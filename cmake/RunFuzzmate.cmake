# RunFuzzmate.cmake — script-mode helper (build time)
#
# -D variables:
#   FUZZMATE     — path to fuzzmate binary
...
#   WORK_DIR     — CMAKE_SOURCE_DIR (fuzzmate resolves targets relative to this)
...
if(NOT _rc EQUAL 0)
    message(FATAL_ERROR "fuzzmate failed (exit ${_rc})")
endif()